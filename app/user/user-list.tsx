      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th scope="col" className="text-left p-2">{t('user.passwordHash.label')}</th>
            <th scope="col" className="text-left p-2">{t('user.isActive.label')}</th>
        ...
        <tbody className="border-t-2 border-black">
          ...
          <tr key={user.id} className="odd:bg-gray-100">
            ...
            <td className="p-2">{user.passwordHash}</td>
            <td className="p-2">{user.isActive?.toString()}</td>
