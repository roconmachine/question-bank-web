...
export default function CategoryEdit() {
  ...
  const updateCategory = async (data: CategoryDTO) => {
    ...
    try {
      ...
      await axios.put('/api/categories/' + currentId, payload);
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(updateCategory)} noValidate>
      ...
      <input type="submit" value={t('category.edit.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 cursor-pointer mt-6" />
    </form>
  </>);
}
