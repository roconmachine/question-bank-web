...
export default function RoleAdd() {
  ...
  // const [permissionValues, setPermissionValues] = useState<Map<number,string>>(new Map());
  ...
  //     setPermissionValues(rolePermissionPermissionsValuesResponse.data);
  //   } catch (error: any) {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(createRole)} noValidate>
      ...
      {/* <InputRow useFormResult={useFormResult} object="role" field="rolePermissionPermissions" type="multiselect" options={permissionValues} /> */}
