...
```
java -Dspring.profiles.active=production -jar ./target/question-bank-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=pulse.io/question-bank
```
