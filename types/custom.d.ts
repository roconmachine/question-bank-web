...
declare module 'yup' {
  ...
  interface ArraySchema<TIn extends any[] | null | undefined, TContext, TDefault = undefined, TFlags extends yup.Flags = ''> extends yup.Schema<TIn, TContext, TDefault, TFlags> {
    emptyToNull(msg?: yup.Message): yup.ArraySchema<TIn | null, TContext, TDefault, TFlags>;
  }
}
